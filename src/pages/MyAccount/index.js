...
const Page = () => {
  ...
  const handleEdit = async e => {
    ...
    let isNullPassword =
      ...
      (typeof password !== "object" || !password);

    let isNullConfirmPassword =
      typeof confirmPassword !== "undefined" &&
      (typeof confirmPassword !== "object" || !confirmPassword);

    if (!isNullPassword || !isNullConfirmPassword) {
    ...
    const json = await api.edit(name, email, password, stateLocal);
